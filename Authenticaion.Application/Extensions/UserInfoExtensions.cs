...
namespace Authenticaion.Application.Extensions
{
    ...
    {
        public static IEnumerable<UserInfoDto> ToUserInfoDtoList(this IEnumerable<UserInfo> userinfos)
        {
            return userinfos.Select(userinfo => new UserInfoDto(
                ...
                Year: userinfo.Year,
                UserInfoDetails: userinfo.Items.Select(i => new UserInfoDetailDto(userinfo.Id.Value, i.Id.Value, i.AccountCode, i.AccountName, i.Password, i.FacultyDetail)).ToList(),
